...
const CalcRow = ({ id, activeNalog, defStore = "", defCategory = "", defSubject = "",
    ...
    return isRemoved ? "" :
        <tr>
            ...
            <td>{(price)}&nbsp;&nbsp;₽</td>
            <td>{Math.round(((price - (subjectData.CostStorageBox * turnover) - logisticMarketplace - (commission * price / 100)) / 100 * 6))}&nbsp;&nbsp;₽</td>
            <td>{Math.round(((price - (subjectData.CostStorageBox * turnover) - logisticMarketplace - (commission * price / 100)) / 100 * 6) * count)}&nbsp;&nbsp;₽</td>
        </tr>
}
    ...
    useEffect(() => {
        ...
        subjectsDataFunc.getCalculations(auth.user.id).then(res => {
            ...
            const newSections = res.map(data => {
                // console.log(data);
                return <CalcRow auth={auth} subjectsDataFunc={subjectsDataFunc} id={data.id} activeNalog={activeNalog}
    ...
    return (
        ...
        <section className="home">
            ...
            <div className="block">
                ...
                <div className="block_nalog6">
                    <div className="rectangle"></div>
                </div>

                <div className="textnalog6">Упрощенная система налогооблажения</div>
                <div className="textnalog6two">Доходы 6%</div>

                <div className="banerusn6">
                    <a href="https://www.marketstat.app/nalog6"><img src="/img/Banerusn6.svg" height="150px" /></a>
                </div>
            ...
            <div className="textnalog">Налоговые отчисления (налоговый режим)</div>
